...
# 5. Проверял, что это имя скачанного файла совпадает с именем файла-установщика, указанного на сайте
  ...
  Функция: UI
    ...
    Сценарий: Работа с web-страницей
      ...
      И кликаю по кнопке с текстом "Скачать"
      И скачиваю последний стабильный релиз
      И проверяю что скаченный файл находится в нужной директории
      И проверяю что имя скаченного файла совпадает с именем файла-установщика указанного на сайте
